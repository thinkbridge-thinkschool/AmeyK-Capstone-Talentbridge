...
public interface IResumeStorageService
{
    ...
    Task<ResumeAccessResult?> GenerateSasUrlAsync(string blobUrl, TimeSpan expiry, CancellationToken ct);
}

public record ResumeAccessResult(string Url, string FileName, string FileType);
